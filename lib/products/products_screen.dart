    ...
    return BlocConsumer<ShopeCubit, ShopeStates>(
        ...
        builder: (context, state) {
          return ConditionalBuilder(
              condition: ShopeCubit.get(context).homeModel != null&&ShopeCubit.get(context).categoriesModel != null,
              builder: (context) =>
                  productsBuilder(ShopeCubit.get(context).homeModel,ShopeCubit.get(context).categoriesModel,context),
              fallback: (context) =>
                    ...
                    children: [
                      ...
                      IconButton(
                         ...
                         ShopeCubit.get(context).changeFavorites(model.id!);
                          ...
                          icon: CircleAvatar(
                            radius: 15.0,
                            backgroundColor:ShopeCubit.get(context).favorits[model.id]! ? defaultColors : Colors.grey,
                            child: Icon(
