...
class ProductsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<ShopeCubit, ShopeStates>(listener: (context, state) {
      ...
      return ConditionalBuilder(
          condition: ShopeCubit.get(context).homeModel != null &&
              ShopeCubit.get(context).categoriesModel != null,
